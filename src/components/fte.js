...
class FteComponent extends React.Component {
  ...
  componentDidMount() {
    ...
    const assetsUrl = "https://raw.githubusercontent.com/qw-ctf/qtube-assets/assets"
    ...
    const mapContent = /(dm[1-7]|e[1-4]m[1-8])/.test(this.props.map)
      ...
      : this.props.map == "mammoth" ?
        {
          [targetMapBsp]: `https://media.githubusercontent.com/media/qw-ctf/qtube-maps/main/mammoth.bsp`
        }
      : {
